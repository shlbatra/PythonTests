...
employee_to_test = Employee(
    name="Arjan", employee_id=12345
)  # dont use global instances for tests


class TestEmployeeComputePayout(unittest.TestCase):
    """Test the compute_payout method of the Employee class."""

    def test_employee_attributes(self):  # not reqd to test python built in functions
    ...
    def compute_payout(self, employee: Employee) -> float:  # not compare method output
        # in test with implemented functionality. compare with a value.
