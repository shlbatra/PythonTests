...
if __name__ == "__main__":
    unittest.main()
# Implemented functionality and all tests passing now. in green phase now.
# code adheres to specifications. now move small things like
# -> employer costs break down to employer_office_costs, employer_401k_Costs, employer_support_Costs -> refactor stage
